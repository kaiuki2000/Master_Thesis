...
\input{Thesis_Base_Algorithm} % add new .tex files for new chapters
\cleardoublepage
...
\input{Thesis_Exploratory_Ideas} % file "Thesis_Exploratory_Ideas.tex"
\cleardoublepage % I swear these commands are so weird... If the page number is odd, it adds a blank page to make it even. If it's even, it doesn't add a blank page. I don't know why we would want this, but whatever. It's in here already, so I just keep the tradition.
...
% For ArXiv references, use the 'utphys' bibliography style
% \bibliographystyle{utphys}

\begingroup % Reduce the font size of the bibliography
\small % Reduce the font size of the bibliography

% Let's try that again, but with the 'hunsrtnat' bibliography style
...
\endgroup % Restore the font size of the bibliography
