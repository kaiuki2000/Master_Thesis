...
\begin{figure*}
    ...
    \begin{subfigure}[t]{0.90\textwidth}
		...
		\caption{\raggedright Non-deterministic CNOT-gate-using schemes compared to \acrshort{qaoa}, \acrshort{qemc}, and a randomly chosen \acrshort{iqaqe} instance. Vanilla refers to the Unmodified Extended-\acrshort{qemc}.}
