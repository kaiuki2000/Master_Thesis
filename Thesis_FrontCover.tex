...
\vspace{1.0cm}
{\FontLb Development of a new variational quantum algorithm for MaxCut: QAOA and QEMC hybrid algorithm} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
...
\begin{tabular}{ll}
 \coverSupervisors: & Prof. Yasser Rashid Revez Omar \\ % <<<<< EDIT NAME
                    & Prof. Joao Carlos Carvalho de Sá Seixas    % <<<<< EDIT NAME
\end{tabular} } \\
\vspace{1.0cm}
