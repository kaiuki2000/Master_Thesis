...
\floatstyle{plaintop} % Trying to get the Tables' captions to appear above the tables.
\restylefloat{table}
...
\usepackage{changepage} % Also added by me. For the adjustwidth environment.