...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.465\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{Figures/Chapter_5/Correlation-based/k=2(Reg.+Ones).png}
  ...
  \begin{subfigure}[t]{0.465\textwidth}
      \centering
      \includegraphics[width=0.95\textwidth]{Figures/Chapter_5/Correlation-based/k=2_3_4.png}
